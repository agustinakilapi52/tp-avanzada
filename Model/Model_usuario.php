...
class Model_usuario extends BaseDatos
{
    ...
    public function Modificar($actualizar_pass = 0)
    {
        ...
        if ($actualizar_pass) {
            ...
            if ($this->getImagenPerfil() == '') {
                $query = "UPDATE usuario SET idusuario='{$this->getIdUsuario()}',usnombre='{$this->getUserNombre()}',uspass='{$this->getUserPass()}',ustelefono='{$this->getUserTelefono()}',usmail='{$this->getUserMail()}',usdeshabilitado='{$this->getUserDeshabilitado()}' WHERE idusuario = {$this->getIdUsuario()}";
            } else {
                $query = "UPDATE usuario SET idusuario='{$this->getIdUsuario()}',usnombre='{$this->getUserNombre()}',uspass='{$this->getUserPass()}',ustelefono='{$this->getUserTelefono()}',usmail='{$this->getUserMail()}',imagen_perfil='{$this->getImagenPerfil()}',usdeshabilitado='{$this->getUserDeshabilitado()}' WHERE idusuario = {$this->getIdUsuario()}";
            }

        } else {
            
            if ($this->getImagenPerfil() == '') {
                $query = "UPDATE usuario SET idusuario='{$this->getIdUsuario()}',usnombre='{$this->getUserNombre()}',ustelefono='{$this->getUserTelefono()}',usmail='{$this->getUserMail()}',usdeshabilitado='{$this->getUserDeshabilitado()}' WHERE idusuario = {$this->getIdUsuario()}";
            } else {
                $query = "UPDATE usuario SET idusuario='{$this->getIdUsuario()}',usnombre='{$this->getUserNombre()}',ustelefono='{$this->getUserTelefono()}',usmail='{$this->getUserMail()}',imagen_perfil='{$this->getImagenPerfil()}',usdeshabilitado='{$this->getUserDeshabilitado()}' WHERE idusuario = {$this->getIdUsuario()}";
            }
